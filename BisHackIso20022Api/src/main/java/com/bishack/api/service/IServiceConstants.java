...
public interface IServiceConstants {
	...
	List<String> BBAN_AC_FORMAT_LOW = Arrays.asList("123110040000109876543210", "DE41500105170123456789");
	List<String> BBAN_AC_VERIFY_LOW = Arrays.asList("123110040000109876543210", "DE41500105170123456789");
	
	List<String> BBAN_AC_VERIFY_MEDIUM = Arrays.asList("DE39100000010123123123");
	List<String> BBAN_AC_FORMAT_MEDIUM = Arrays.asList("DE39100000010123123123");
