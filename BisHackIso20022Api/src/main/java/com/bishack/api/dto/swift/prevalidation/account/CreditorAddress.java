...
@JsonPropertyOrder({ "department", "sub_department", "street_name", "building_number", "building_name", "floor",
        "post_box", "room", "post_code", "town_name", "town_location_name", "district_name", "country_sub_division",
